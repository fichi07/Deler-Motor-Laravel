...
try {
    ...
    $response =  $client->request('GET', '/api/motorkeluar/'.$_GET['id']);
...
if (isset($_POST['edit'])) {
    try {
        ...
        $response =  $client->request('PUT', '/api/motorkeluar/' . $data_body['data']['id'], [
            'json' => [
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" value="<?= $data_body['data']['pemesan']; ?>" name="pemesan">
                        </div>

                        <h6 class="m-0 font-weight-bold text-primary">ID Motor</h6>
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" value="<?= $data_body['data']['id_motor']; ?>" name="id_motor">
                        </div>

                        <h6 class="m-0 font-weight-bold text-primary">Alamat</h6>
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" value="<?= $data_body['data']['alamat']; ?>" name="alamat">
                        </div>

                        <h6 class="m-0 font-weight-bold text-primary">No Telepon</h6>
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" value="<?= $data_body['data']['notlp']; ?>" name="notlp">
                        </div>

                        
                        <h6 class="m-0 font-weight-bold text-primary">Status</h6>
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" value="<?= $data_body['data']['status']; ?>" name="status">
                        </div>
